 ...
 * @author ferja
 */
public class ModifierAvistForm extends BaseForm {
    ...
    public ModifierAvistForm(int idAvis) {
         this(com.codename1.ui.util.Resources.getGlobalResources());
         Validator val = new Validator();
         val.setShowErrorMessageForFocusedComponent(true);
                val.addConstraint(description, new LengthConstraint(2, "Modifier votre avis !"));
...
//                    Avis t = new Avis(description.getText());
                    ServiceAvis.getInstance().updateAvis(description.getText(),User.getId(),idAvis); 
...
//                    } 
     ...
     public ModifierAvistForm (com.codename1.ui.util.Resources resourceObjectInstance){
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">     
        ...
        gui_Label_1.setText(" > Entrez votre avis ");
       ...
       // gui_Text_Field_1.setName("txt_nom");
        ...
        gui_Label_4.setText(" description_Avis ");
        gui_Label_4.setName("description_Avis");
