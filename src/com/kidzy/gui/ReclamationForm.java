...
// <editor-fold defaultstate="collapsed" desc="Generated Code">     
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        setTitle("ReclamationsForm");
        setName("ReclamationsForm");
        ...
        gui_Label_3.setText(" > Liste des réclamations ");
        gui_Label_3.setName("Label_3");
        gui_Label_3.setUIID("BoldLabel");

        gui_Container_2.addComponent(gui_Button_2);
        gui_Button_2.setText(" + Ajouter réclamation ");
        gui_Button_2.setName("Button_2");
        gui_Button_2.addActionListener(e -> new AddReclamationForm().show());
       ...
       // for (Enfant e : listEnfant) {
        user User =Session.getCurrentSession();
         ArrayList<Reclamations> listRec = ServiceReclamation.getInstance().getMesRecMobile(User.getId());
        ...
        String date =listRec.get(i).getDate_rec();
        String sousChaine = date.substring(5, 16);

            Label DesAvis = new Label( "Déscription :"+listRec.get(i).getDescription_rec());
            Label Desc = new Label("Date :" + sousChaine);

           //int idAvis=listRec.get(i).getId_rec();
