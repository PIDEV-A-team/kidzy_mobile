...
public class AvisForm extends BaseForm {
    ...
    public AvisForm(com.codename1.ui.util.Resources resourceObjectInstance) {
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">     
    ...
    private void initGuiBuilderComponents(com.codename1.ui.util.Resources resourceObjectInstance) {
        ...
        gui_Label_3.setText(" > Liste des avis ");
        gui_Label_3.setName("Label_3");
        gui_Label_3.setUIID("BoldLabel");

        gui_Container_2.addComponent(gui_Button_2);
        gui_Button_2.setText(" Consulter mes avis ");
        gui_Button_2.setName("Button_2");
        gui_Button_2.addActionListener(e -> new MesAvisForm().show());
        ...
        //gui_Text_Area_1_4.setText(ServiceAvis.getInstance().getAllAvis().toString());
        // Form f2 = new Form(BoxLayout.y());
       
        gui_Container_2.addComponent(gui_Button_3);
        gui_Button_3.setText(" + Ajouter  avis ");
        gui_Button_3.setName("Button_3");
        gui_Button_3.addActionListener(e -> new AddAvistForm().show());
        gui_Button_3.setUIID("InboxNumber");
       ...
       // for (Enfant e : listEnfant) {
         ...
         ArrayList<Avis> listAvis = ServiceAvis.getInstance().getAllAvis();
...
//            Label us = new Label( "Parent :"+listAvis.get(i).getUser().getNom()+" " +listAvis.get(i).getUser().getPrenom());
           ...
           // Enfant e = new Enfant();
            ...
            //} else {
               ...
               /// classe.setText("--------");
                // classe.setText(listEnfant.get(i).getIdClasse().getLibelle_cla());
            //}
//            ct1.add(us).add(DesAvis).add(Desc);}
            ct1.add(DesAvis).add(Desc);}
