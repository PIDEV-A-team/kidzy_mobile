...
public class AutresClubsForm extends BaseForm{
    ...
    public AutresClubsForm (com.codename1.ui.util.Resources resourceObjectInstance) {
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">     
        ...
        setTitle("AutresClubForm");
        setName("AutresClubForm");
...
//        gui_Button_2.addActionListener(e -> new AutresClubsForm().show());
         ArrayList<Club> club = ServiceClub.getInstance().getAutresClubs();
...
//       gui_Button_2.setIcon(resourceObjectInstance.getImage("image"));
      ...
      gui_Container_3.addComponent(gui_Label_2);
        gui_Label_3.setText(" > Autres Clubs clubs ");
       ...
       gui_Container_5.addComponent(mariem);
        ...
        Label clubN = new Label(club.get(i).getNomClub());
               Label nom = new Label(club.get(i).getDescriptionClub());
                String nomClub=club.get(i).getNomClub();
                int idClub=club.get(i).getIdClub();
...
//
                 InscriptionForm inscrit;
////                 
                inscrit = new InscriptionForm(nomClub,idClub);
