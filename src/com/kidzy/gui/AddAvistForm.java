 ...
 * @author ferja
 */
public class AddAvistForm extends BaseForm {
    ...
    public AddAvistForm() {
     ...
     public AddAvistForm (com.codename1.ui.util.Resources resourceObjectInstance){
       ...
       // gui_Container_3.addComponent(gui_Text_Field_3);
        ...
        Validator val = new Validator();
         val.setShowErrorMessageForFocusedComponent(true);
                val.addConstraint(description, new LengthConstraint(2, "Entrez votre avis !"));
...
//                    Avis t = new Avis(description.getText());
                    ServiceAvis.getInstance().addAvis(description.getText(),User.getId()); 
