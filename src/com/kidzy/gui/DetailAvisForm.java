 ...
 * @author ferja
 */
public class DetailAvisForm extends BaseForm  {
    
    ServiceAvis servAvis = new ServiceAvis();
    
     public DetailAvisForm(int id_avis , String date_avis, String description_avis ) {
         this(com.codename1.ui.util.Resources.getGlobalResources());
         
           //gui_Container_5.addComponent(gui_Label_1_1);
        
        gui_Label_1_1.setText(date_avis);
         gui_Label_4_1.setText(description_avis);
                ...
                //public void actionPerformed(ActionEvent evt) {
                    ...
                    //Avis e = new Avis();
                //     new ModifierAvisForm(int id_avis , String date_avis, String description_avis ).show();
               // }
            //});
    }
    
      public DetailAvisForm (com.codename1.ui.util.Resources resourceObjectInstance){
      ...
      // getToolbar().addCommandToLeftBar("", mat, e -> new EnfantForm().show());
        getToolbar().addMaterialCommandToLeftBar("", FontImage.MATERIAL_ARROW_BACK, e-> new AvisForm().showBack());
...
// <editor-fold defaultstate="collapsed" desc="Generated Code">     
      ...
      //  gui_Container_3.getStyle().getBgColor();
       ...
       gui_Container_6.addComponent(gui_Label_4);
        gui_Label_4.setText(" Description avis :");
        gui_Label_4.setName("Date");
